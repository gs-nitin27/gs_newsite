...
if($_SERVER['REMOTE_ADDR'] == '122.177.99.187' || $_SERVER['REMOTE_ADDR'] == '::1'|| $_SERVER['REMOTE_ADDR'] == '116.75.228.87' || $_SERVER['REMOTE_ADDR'] == '47.30.5.67')  // Check fr testing environment
{
