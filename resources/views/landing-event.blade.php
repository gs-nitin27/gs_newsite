...
@section('content')
         ...
         <div class="joblist-bg landgEventBg bannerBgSec">
           <div class="container">
       	     <div class="row">
       	       <div class="col-md-12">
         		     <div class="ban-pera">
                 ...
                 <div class="">
                    <section class="showCaseBox">                      
                      <aside class="showCaseText">
                        <div class="clearfix ponting">
                            <h3>Create & Manage Sports
events</h3>
                            <p>One can create, post & manage sports.</p>
                            <p>Competition & Events with our features.</p>  
                        </div>
                      </aside>
                      <aside class="showCaseImg img-responsive"><img src="public/img/event-mob.jpg" alt=""/></aside>
                  </section>                        
                  </div>
            ...
            <div class="clearfix margin20"></div>
        	  <div class="container">
                  ...
                  <section class="showCaseBox">
                      <aside class="showCaseImg"><img src="public/img/event-mob.jpg" alt=""/></aside>
                      <aside class="showCaseText">
                        <div class="clearfix">
                            <h3>register</h3>
...
the App. </p>
           ...
           <div class="clearfix landingAdv">
            <figure><img class="img-responsive" src="public/img/adv_event.jpg" alt=""/></figure>
          </div>
          <section>
            <div class="container">
                  <div class="heading-center  m0 pad15">
