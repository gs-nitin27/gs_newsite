...
@section('content')
     ...
     <a href="https://twitter.com/share" class="twitter-share-button fa fa-twitter" data-size="large" data-text="{{$name[0]->description}}" data-url="http://localhost/get/gs_newsite/event-detail/{{$name[0]->id}}" data-show-count="false" >
    </a> 
